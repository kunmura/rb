<div class="players index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('stamina_p');?></th>
			<th><?php echo $this->Paginator->sort('battle_p');?></th>
			<th><?php echo $this->Paginator->sort('quest');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $player['Player']['level']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['exp']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['stamina_p']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['battle_p']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['quest']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['visible']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['creates']; ?>&nbsp;</td>
		<td><?php echo $player['Player']['modified']; ?>&nbsp;</td>
		<td class="actions">
