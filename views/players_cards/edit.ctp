...
<?php echo $this->Form->create('PlayersCard');?>
	<fieldset>
 		<legend><?php __('Edit Players Card'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PlayersCard.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PlayersCard.id'))); ?></li>
