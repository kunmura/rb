<div class="effects index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $effect['Effect']['name']; ?>&nbsp;</td>
		<td><?php echo $effect['Effect']['atk']; ?>&nbsp;</td>
		<td><?php echo $effect['Effect']['def']; ?>&nbsp;</td>
		<td><?php echo $effect['Effect']['agi']; ?>&nbsp;</td>
		<td><?php echo $effect['Effect']['creates']; ?>&nbsp;</td>
